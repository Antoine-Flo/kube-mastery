...
import type { DeploymentUpdatedEvent, ReplicaSetCreatedEvent, ReplicaSetUpdatedEvent } from '../../../../src/core/cluster/events/types'
...
describe('DeploymentController', () => {
    ...
    describe('reconcile', () => {
        ...
        it('should scale down old ReplicaSets when template changes', () => {
            ...
            eventBus.subscribe('ReplicaSetUpdated', (event: ReplicaSetUpdatedEvent) => {
                if (event.payload.replicaSet.metadata.name === 'my-deploy-oldhashttt' &&
