...
- **Helm**: Charts, templates, values, repositories, hooks — packaging applications for Kubernetes
- **Istio**: Service mesh, traffic management, observability, and mutual TLS

**Who is this for?**

Platform engineers, Kubernetes architects, teams building internal developer platforms, and anyone who wants to go beyond using Kubernetes to actually extending it.

**Prerequisites:** Kubernetes Developer OR Kubernetes Operator (you need solid experience with the K8s API before extending it).
