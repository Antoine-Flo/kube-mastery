...
Creates the namespace. All subsequent commands target this namespace with `-n exercise-01`. <a href="https://kubemastery.com/en/courses/cka/what-are-namespaces" target="_blank" rel="noopener noreferrer">Reference lesson.</a>
...
This step creates the pod with the expected metadata and resource constraints. <a href="https://kubemastery.com/en/courses/cka/creating-your-first-pod" target="_blank" rel="noopener noreferrer">Reference lesson.</a>
...
Labels are mutable metadata, no pod restart is required. <a href="https://kubemastery.com/en/courses/cka/what-are-labels" target="_blank" rel="noopener noreferrer">Reference lesson.</a>
