...
:::info
Since this is a browser-based simulation, some features might be limited or behave slightly differently. If you notice an error or issue in the course, click the pen icon at the bottom right of the window to suggest a correction.
:::
...
Don't hesitate to experiment, you can't break anything! This is your safe space to learn. If something goes wrong, just reload the page and you're back to a fresh start. The beauty of a simulated environment is that mistakes are free and learning is unlimited.
