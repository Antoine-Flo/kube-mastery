  ...
  questions: [
    {
      ...
      options: ['Environment variables only', 'DNS', 'Hard-coded IP addresses', 'ConfigMaps'],
      correctAnswer: 1
    },
    {
      id: 'q2',
      ...
      options: ['After the client Pods', 'Before the client Pods', 'At the same time', "It doesn't matter"],
      correctAnswer: 1
    }
  ]
}
