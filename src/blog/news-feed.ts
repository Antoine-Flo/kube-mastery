...
const englishNews: NewsItem[] = [
  ...
  },
  {
    ...
    sourceUrl: 'https://www.networkworld.com/article/4150130/meshery-1-0-debuts-offering-new-layer-of-control-for-cloud-native-infrastructure.html',
    headline: 'Meshery 1.0 ships a visual governance layer for Kubernetes infrastructure',
    tldr:
  ...
  },
  {
    ...
    sourceUrl: 'https://www.cncf.io/blog/2026/03/17/when-kubernetes-restarts-your-pod-and-when-it-doesnt/',
    headline: 'A production guide to when Kubernetes actually restarts your pod',
    tldr:
  ...
  },
  {
    ...
    sourceName: 'CNCF Blog',
    sourceUrl: 'https://www.cncf.io/blog/2026/03/26/announcing-kubescape-4-0-enterprise-stability-meets-the-ai-era/',
    headline: 'Kubescape 4.0 ships runtime threat detection GA and AI agent security scanning',
    tldr:
...
const frenchNews: NewsItem[] = [
  {
    ...
    tldr:
      'Broadcom cede Velero a la CNCF, le backup Kubernetes de reference devient communautaire. VKS 3.6 ajoute le bring-your-own-CNI et des profils de performance pour les bases de donnees et workloads IA.',
    whyItMatters:
  ...
  },
  {
    ...
    tldr:
      'Des identifiants Aqua Security voles ont permis de pousser des versions piégées de Trivy (0.69.4-0.69.6) sur Docker Hub. Ca a declenche un ver sur npm et un wiper qui detruisait des clusters Kubernetes via des DaemonSets privilegies. CVE-2026-33634, CVSS 9.4.',
    whyItMatters:
  ...
  },
  {
    ...
    sourceName: 'Network World',
    sourceUrl: 'https://www.networkworld.com/article/4150130/meshery-1-0-debuts-offering-new-layer-of-control-for-cloud-native-infrastructure.html',
    headline: 'Meshery 1.0 : une couche de gouvernance visuelle pour l infrastructure Kubernetes',
    tldr:
      'Meshery passe en v1.0 apres six ans. Plutot que du YAML brut, votre equipe travaille dans Kanvas, un designer visuel qui valide les changements via OPA et supporte 300+ integrations. Ca se pose au-dessus de vos outils IaC existants.',
    whyItMatters:
  ...
  },
  {
    ...
    tldr:
      'Un maintainer CNCF detaille exactement ce qui declenche un restart de container, une recreation de pod, ou rien du tout. ConfigMaps, mises a jour d image, resize in-place (GA en 1.35), Istio et Stakater Reloader, chaque scenario avec des sorties de lab verifiees.',
    whyItMatters:
  ...
  },
  {
    ...
    sourceName: 'CNCF Blog',
    sourceUrl: 'https://www.cncf.io/blog/2026/03/26/announcing-kubescape-4-0-enterprise-stability-meets-the-ai-era/',
    headline: 'Kubescape 4.0 : detection de menaces en temps reel GA et scan de securite pour agents IA',
    tldr:
      'Kubescape 4.0 passe la detection de menaces en temps reel et le stockage de securite en production stable, et supprime le DaemonSet host-sensor intrusif. Un plugin permet aux agents IA de scanner la posture du cluster, et 15 controles securisent les deployments KAgent.',
    whyItMatters:
