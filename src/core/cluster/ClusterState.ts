...
export interface ClusterState {
    ...
    updateReplicaSet: (name: string, namespace: string, updateFn: (replicaSet: ReplicaSet) => ReplicaSet) => Result<ReplicaSet>
    ...
    updateDeployment: (name: string, namespace: string, updateFn: (deployment: Deployment) => Deployment) => Result<Deployment>
