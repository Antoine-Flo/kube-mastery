...
export interface GeneratedResourceHandlerRegistry {
  ...
  serviceaccounts: ResourceHandler<ClusterResourceTypeByCollectionKey['serviceAccounts']>
  roles: ResourceHandler<ClusterResourceTypeByCollectionKey['roles']>
  rolebindings: ResourceHandler<ClusterResourceTypeByCollectionKey['roleBindings']>
  clusterroles: ResourceHandler<ClusterResourceTypeByCollectionKey['clusterRoles']>
  clusterrolebindings: ResourceHandler<ClusterResourceTypeByCollectionKey['clusterRoleBindings']>
