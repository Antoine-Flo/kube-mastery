...
const createPodFromTemplate = (rs: ReplicaSet): Pod => {
  ...
  return createPod({
    ...
    dnsPolicy: rs.spec.template.spec.dnsPolicy,
    enableServiceLinks: rs.spec.template.spec.enableServiceLinks,
    preemptionPolicy: rs.spec.template.spec.preemptionPolicy,
    priority: rs.spec.template.spec.priority,
    priorityClassName: rs.spec.template.spec.priorityClassName,
    restartPolicy: rs.spec.template.spec.restartPolicy,
    schedulerName: rs.spec.template.spec.schedulerName,
    securityContext: rs.spec.template.spec.securityContext,
    serviceAccount: rs.spec.template.spec.serviceAccount,
