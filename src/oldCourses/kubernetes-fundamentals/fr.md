...
Votre point de départ essentiel pour Kubernetes. Ce cours vous guide à travers tous les concepts fondamentaux et vous donne une expérience pratique du déploiement d'applications sur un cluster.
...
Tout parcours Kubernetes — que vous soyez développeur déployant des applications, SRE sécurisant des clusters, ou ingénieur plateforme étendant l'API — commence par les mêmes fondations. Ce cours vous donne le vocabulaire commun, l'aisance avec kubectl, et une vraie expérience de déploiement et d'exposition d'applications.
