...
- **`spec.selector.matchLabels`:** the label query the Deployment uses to find _its_ Pods. Think of it as the Deployment's way of saying "these Pods belong to me."
