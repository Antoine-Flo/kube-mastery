...
Every Pod is made of three main sections: **metadata**, **spec**, and **status**. Think of these as the _who_, the _what_, and the _how it's going_:
...
The `spec` section is where you describe _what you want Kubernetes to run_. This is the heart of your Pod definition.
...
- **`initContainers`:** containers that run to completion _before_ the main containers start. Useful for setup tasks like database migrations or config fetching.
