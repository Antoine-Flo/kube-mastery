...
You now understand _why_ Jobs exist and _what_ they do. In the next lesson, we will dive into the **Job specification:** the fields that let you control parallelism, completion counts, deadlines, and more.
