...
Opens the live Deployment object in your terminal editor, letting you modify any field. Find the `spec.template.spec.containers` section, change the `image` field, save, and close. The rollout starts as soon as you save. This method is useful when you need to change multiple template fields at once — for example, updating an image _and_ adding an environment variable in the same operation.
