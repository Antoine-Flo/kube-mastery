...
- **Helm** : Charts, templates, values, repositories, hooks — packager des applications pour Kubernetes
- **Istio** : Service mesh, gestion du trafic, observabilité et mutual TLS

**Pour qui ?**

Ingénieurs plateforme, architectes Kubernetes, équipes qui construisent des plateformes développeur internes, et tous ceux qui veulent aller au-delà de l'utilisation de Kubernetes pour l'étendre.

**Prérequis :** Kubernetes Développeur OU Kubernetes Opérateur (vous avez besoin d'une expérience solide avec l'API K8s avant de l'étendre).
