...
const courseMdGlob = import.meta.glob<MarkdownInstance<CourseFrontmatter>>("../../courses/*/{en,fr}.md", { eager: true });
const structuresGlob = import.meta.glob("../../courses/*/course-structure.ts", { eager: true }) as Record<string, { courseStructure: CourseStructure }>;
const modulesGlob = import.meta.glob("../../courses/modules/*/module.ts", { eager: true, }) as Record<string, { module: LocalModule }>;
