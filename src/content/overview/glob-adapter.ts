...
const lessonTitleGlob = import.meta.glob<string>("../../courses/modules/**/content.md", { eager: true, query: "?raw", import: "default" });
const chapterMetaGlob = import.meta.glob<{ default: Record<string, unknown> }>("../../courses/modules/*/*/chapter.json", { eager: true, import: "default" });
...
const contentRawGlob = import.meta.glob<string>("../../courses/modules/**/content.md", { eager: true, query: "?raw", import: "default" });
const contentAsMarkdownGlob = import.meta.glob<MarkdownInstance<Record<string, unknown>>>("../../courses/modules/**/content.md", { eager: true });
